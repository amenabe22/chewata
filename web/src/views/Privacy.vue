  ...
  <div class="flex items-center justify-center">
    <div class="prose pt-28 px-5">
      ...
      <p>
        ...
        shared and/or collect in chewata. This policy is not applicable to any
      ...
      <p>
        chewata follows a standard procedure of using log files. These files log
      ...
      <p>
        Like any other website, chewata uses 'cookies'. These cookies are used
      ...
      <P
        ...
        advertising partners of chewata.</P
      >

      <p>
        Third-party ad servers or ad networks uses technologies like cookies,
        JavaScript, or Web Beacons that are used in their respective
        advertisements and links that appear on chewata, which are sent directly
      ...
      <p>
        Note that chewata has no access to or control over these cookies that
      ...
      <p>
        chewata's Privacy Policy does not apply to other advertisers or
      ...
      <p>
        chewata does not knowingly collect any Personal Identifiable Information
